# from django.shortcuts import render не понадобится он для функционального представления
...
class CatalogView(TemplateView):
    template_name = "main/base.html"
    # через мапинг FILTER_MAPPING словарь который отвечает за сортировку queryset
    #  это наш массив с продуктами value это то что выбрал человек в сортировке
    FILTER_MAPPING = {
